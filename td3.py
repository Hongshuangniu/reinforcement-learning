...
class TD3:
    ...
    def __init__(self, state_dim: int, action_dim: int):
        ...
        self.actor_target = BaseActorNetwork(
            state_dim, action_dim, CONFIG.train.HIDDEN_DIM
        ).to(self.device)
        ...
        self.policy_delay = CONFIG.algo.TD3_POLICY_DELAY
        self.target_noise = CONFIG.algo.TD3_TARGET_NOISE
        self.noise_clip = CONFIG.algo.NOISE_CLIP
        self.exploration_noise = CONFIG.algo.NOISE_STD
